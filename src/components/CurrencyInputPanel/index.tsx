...
import { Button, ChevronDownIcon, Text } from '@robustswap-libs/uikit'
...
const CurrencySelect = styled.button<{ selected: boolean }>`
  ...
  :focus,
  :hover {
    background: linear-gradient(90.04deg, rgba(12, 7, 32, 0.4) 0.04%, rgba(41, 26, 131, 0.4) 99.97%);
  }
`
