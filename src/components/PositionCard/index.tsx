...
import { Button, Card as UIKitCard, CardBody, Text } from '@robustswap-libs/uikit'
...
export function MinimalPositionCard({ pair, showUnwrapped = false }: PositionCardProps) {
  ...
  return (
    <>
      {userPoolBalance && (
        <UIKitCard>
          <CardBody style={{ backgroundColor: '#1E215C' }}>
            <AutoColumn gap="12px">
              <FixedHeightRow>
                <RowFixed>
                  <Text style={{ textTransform: 'uppercase', fontWeight: 600 }} fontSize="14px" color="white">
      ...
      <AutoColumn gap="12px">
        <FixedHeightRow onClick={() => setShowMore(!showMore)} style={{ cursor: 'pointer' }}>
          <RowFixed>
            ...
            <Text style={{ fontWeight: 800, fontSize: 20, lineHeight: 24 }}>
