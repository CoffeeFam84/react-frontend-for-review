...
export const ROUTER_ADDRESS = '0x10Ae01d3B3A48F33D841DA0dF586DC1d87c285d8'
export const AGGREGATION_ROUTER_ADDRESS = '0xdf1a1b60f2d438842916c0adc43748768353ec25'
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...WETH_ONLY,
  [ChainId.MAINNET]: [...WETH_ONLY[ChainId.MAINNET], BUSD, USDT, UST, BTCB, ETH, USDC, CAKE],
}
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  [ChainId.MAINNET]: [
    [
      new Token(ChainId.MAINNET, '0x891e4554227385c5c740f9b483e935e3cbc29f01', 18, 'RBT', 'RobustSwap Token'),
